...
export default function CardPlan({restaurant,  closeCard}) {
    ...
    return(
        <div className={"card-cont-plan"}>
            ...
            <div className={"card-cont-reserv-bt"}>
                <div className={"card-reserv-bt"}>
                    Réserver
                </div>
            </div>
        </div>
